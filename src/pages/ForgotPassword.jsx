import BackgroundForgotPasswordImage from '../../assets/images/background_forgot_password.png';
import Logo2WhiteImage from '../../assets/images/logo_2_white.png';
import KeyLineSVG from '../../assets/images/key_line.svg';
import Button from '../components/ui/Button';

const ForgotPassword = () => {
    return (
        <div className="relative flex flex-col justify-center items-center p-8 min-h-screen font-ibm-plex-sans bg-no-repeat bg-[length:100%_auto] md:bg-[length:100%_100%] bg-brand-purple-dark" style={{ backgroundImage: `url(${BackgroundForgotPasswordImage})` }}>
            <img src={Logo2WhiteImage} alt='Logo 2' className='absolute top-12 left-1/2 -translate-x-1/2 h-10 object-contain mb-4 md:mb-7' />
